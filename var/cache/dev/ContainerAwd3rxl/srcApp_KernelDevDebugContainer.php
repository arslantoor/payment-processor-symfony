...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder1cbfd = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer33d32 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties10471 = [
        
    ];

    public function getConnection()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getConnection', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getMetadataFactory', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getExpressionBuilder', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'beginTransaction', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getCache', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getCache();
    }

    public function transactional($func)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'transactional', array('func' => $func), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->transactional($func);
    }

    public function commit()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'commit', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->commit();
    }

    public function rollback()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'rollback', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getClassMetadata', array('className' => $className), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'createQuery', array('dql' => $dql), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'createNamedQuery', array('name' => $name), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'createQueryBuilder', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'flush', array('entity' => $entity), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'clear', array('entityName' => $entityName), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->clear($entityName);
    }

    public function close()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'close', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->close();
    }

    public function persist($entity)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'persist', array('entity' => $entity), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'remove', array('entity' => $entity), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'refresh', array('entity' => $entity), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'detach', array('entity' => $entity), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'merge', array('entity' => $entity), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getRepository', array('entityName' => $entityName), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'contains', array('entity' => $entity), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getEventManager', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getConfiguration', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'isOpen', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getUnitOfWork', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getProxyFactory', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'initializeObject', array('obj' => $obj), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'getFilters', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'isFiltersStateClean', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'hasFilters', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return $this->valueHolder1cbfd->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer33d32 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder1cbfd) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder1cbfd = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder1cbfd->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, '__get', ['name' => $name], $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        if (isset(self::$publicProperties10471[$name])) {
            return $this->valueHolder1cbfd->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1cbfd;
    ...
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;
    ...
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, '__isset', array('name' => $name), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;
    ...
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, '__unset', array('name' => $name), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;
    ...
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, '__clone', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        $this->valueHolder1cbfd = clone $this->valueHolder1cbfd;
    }

    public function __sleep()
    {
        $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, '__sleep', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;

        return array('valueHolder1cbfd');
    }
    ...
    {
        $this->initializer33d32 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer33d32;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer33d32 && ($this->initializer33d32->__invoke($valueHolder1cbfd, $this, 'initializeProxy', array(), $this->initializer33d32) || 1) && $this->valueHolder1cbfd = $valueHolder1cbfd;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder1cbfd;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder1cbfd;
    }
}
